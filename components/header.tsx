...
export default function Header() {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      setCursorTrail((prev) => {
        // Keep more points and remove based on timestamp later
  ...
  useEffect(() => {
    ...
    }, 16) // smoother update, like a frame
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="text-white py-2 md:py-3  sticky top-0 z-50 " style={{ backgroundColor: "#03045E" }}>
      ...
      {/* Main Header */}
      <header className="bg-white shadow-lg sticky top-[44px] z-50 border-b border-blue-100">
                ...
                <AnimatePresence>
                  {isResourcesOpen && (
                    ...
                    >
                      ...
                      <Link href="/testimonials" className="block px-4 py-3 text-gray-700 hover:bg-blue-50 rounded-lg">
                        Testimonials
                      </Link>
                      <Link
                        href="/privacy-policy"
                      ...
                      <Link href="/communication" className="block px-4 py-3 text-gray-700 hover:bg-blue-50 rounded-lg">
                        Communication
                      </Link>
                    </motion.div>
                  )}
      ...
      {/* Cursor Trail Animation with Gradient */}
