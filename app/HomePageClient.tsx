...
const services = [
  ...
  },
  {
    ...
    description: "Tailored enterprise software solutions to streamline operations and drive growth.",
    icon: Code,
    features: ["API Development", "Cloud-Native Apps", "Legacy Modernization"],
